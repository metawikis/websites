...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    return function(modules) {
        ...
        var MDCComponent = function() {
            ...
            MDCComponent.prototype.emit = function(evtType, evtPost, shouldBubble) {
                ...
                if (typeof CustomEvent === "function") {
                    ...
                    evt.initCustomEvent(evtType, shouldBubble, false, evtPost);
                }
        ...
        var MDCRipple = function(_super) {
            ...
            MDCRipple.createAdapter = function(instance) {
                return {
                    ...
                    getWindowShopOffset: function getWindowShopOffset() {
                        return {
        ...
        var MDCRippleFoundation = function(_super) {
            ...
            MDCRippleFoundation.prototype.getFgTranslationCoordinates_ = function() {
                ...
                if (wasActivatedByPointer) {
                    startPoint = util_1.getNormalizedEventCoords(activationEvent, this.adapter_.getWindowShopOffset(), this.adapter_.computeBoundingRect());
                } else {
                    startPoint = {
        ...
        var MDCMenu = function(_super) {
            ...
            MDCMenu.prototype.getDefaultFoundation = function() {
                ...
                var adapter = {
                    ...
                    notifySelected: function notifySelected(evtPost) {
                        return _this.emit(constants_1.strings.SELECTED_EVENT, {
                            index: evtPost.index,
                            item: _this.items[evtPost.index]
                        });
                    },
        ...
        var MDCSliderFoundation = function(_super) {
            ...
            MDCSliderFoundation.prototype.getShopX_ = function(evt) {
            ...
            MDCSliderFoundation.prototype.setValueFromEvt_ = function(evt) {
                var pageX = this.getShopX_(evt);
                var value = this.computeValueFromShopX_(pageX);
                this.setValue_(value, true);
            };
            MDCSliderFoundation.prototype.computeValueFromShopX_ = function(pageX) {
        ...
        function emit(evtType, evtPost, shouldBubble) {
            if (shouldBubble === void 0) {
                shouldBubble = false;
            }
            var evt;
        ...
        var MDCIconButtonToggle = function(_super) {
            ...
            MDCIconButtonToggle.prototype.getDefaultFoundation = function() {
                ...
                var adapter = {
                    ...
                    notifyChange: function notifyChange(evtPost) {
                        return _this.emit(strings.CHANGE_EVENT, evtPost);
                    },
                    removeClass: function removeClass(className) {
                        return _this.root_.classList.remove(className);
                    },
        ...
        var MDCSelect = function(_super) {
            ...
            MDCSelect.prototype.initialSyncWithDOM = function() {
                ...
                this.handleMenuSelected_ = function(evtPost) {
                    return _this.selectedIndex = evtPost.detail.index;
                };
